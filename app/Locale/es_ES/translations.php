...
return array(
    ...
    'CNY - Chinese Yuan' => 'CNY - Yen Chino',
    ...
    'Project tags management' => 'Administración de etiquetas de proyecto',
    'Tag created successfully.' => 'Etiqueta creada correctamente',
    'Unable to create this tag.' => 'No es posible crear esta etiqueta',
    'Tag updated successfully.' => 'Etiqueta actualizada correctamente',
    'Unable to update this tag.' => 'No es posible actualizar esta etiqueta',
    'Tag removed successfully.' => 'Etiqueta eliminada correctamente',
    'Unable to remove this tag.' => 'No es posible eliminara esta etiqueta',
    'Global tags management' => 'Administración de etiqueta globales',
    'Tags' => 'Etiquetas',
    'Tags management' => 'Administración de etiquetas',
    'Add new tag' => 'Añadir etiqueta',
    'Edit a tag' => 'Editar etiqueta',
    'Project tags' => 'Etiquetas de proyecto',
    'There is no specific tag for this project at the moment.' => 'Este proyecto no tiene etiquetas en este momento.',
    'Tag' => 'Etiqueta',
    'Remove a tag' => 'Eliminar etiqueta',
    'Do you really want to remove this tag: "%s"?' => '¿Quieres eliminar esta etiqueta: "%s"?',
    'Global tags' => 'Etiquetas globales',
    'There is no global tag at the moment.' => 'No hay etiquetas globales',
    'This field cannot be empty' => 'Este campo no puede estar vacío',
    'Close a task when there is no activity in an specific column' => 'Cerrar una tarea cuando no hay actividad en una columna específica',
    '%s removed a subtask for the task #%d' => '%s ha eliminado una subtarea para la tarea #%d',
    '%s removed a comment on the task #%d' => '%s ha eliminado un comentario en la tarea #%d',
    'Comment removed on task #%d' => 'Comentario eliminado en la tarea #%d',
    'Subtask removed on task #%d' => 'Subtarea eliminada en la tarea #%d',
    'Hide tasks in this column in the dashboard' => 'Ocultar tareas de esta columna en el tablero',
    '%s removed a comment on the task %s' => '%s ha eliminado un comentario en la tarea %s',
    '%s removed a subtask for the task %s' => '%s ha eliminado una subtarea para la tarea %s',
    'Comment removed' => 'Comentario eliminado',
    'Subtask removed' => 'Subtarea eliminado',
    '%s set a new internal link for the task #%d' => '%s a creado un enlace interno para la tarea #%d',
    '%s removed an internal link for the task #%d' => '%s ha eliminado un enlace interno para la tarea #%d',
    'A new internal link for the task #%d have been defined' => 'Se ha definido un nuevo enlace para la tarea #%d',
    'Internal link removed for the task #%d' => 'Se ha eliminado el enlace para la tarea #%d',
    '%s set a new internal link for the task %s' => '%s a creado un enlace interno para la tarea %s',
    '%s removed an internal link for the task %s' => '%s ha eliminado un enlace interno para la tarea %s',
    'Automatically set the due date on task creation' => 'Fijar vencimiento automáticamente al crear la tarea',
    'Move the task to another column when closed' => 'Mover la tarea a otra columna cuando se cierra',
    'Move the task to another column when not moved during a given period' => 'Mover la tarea a otra columna cuando no ha sido movida en un periodo de tiempo establecido',
    'Dashboard for %s' => 'Tablero de %s',
    'Tasks overview for %s' => 'Descripción general de las tareas de %s',
    'Subtasks overview for %s' => 'Descripción general de las subtareas de %s',
    'Projects overview for %s' => 'Descripción general de los proyectos de %s',
    'Activity stream for %s' => 'Flujo de actividades de %s',
    'Calendar for %s' => 'Calendario de %s',
    'Notifications for %s' => 'Notificaciones de %s',
    'Subtasks export' => 'Exportar subtareas',
    'Tasks exportation' => 'Exportación de tareas',
    'Assign a color when the task is moved to a specific swimlane' => 'Asignar un color cuando la tarea se mueve a una calle determinada',
    'Assign a priority when the task is moved to a specific swimlane' => 'Asignar prioridad cuando la tarea se mueve a una calle determinada',
    ...
    'Move a task to another swimlane' => 'Mover la tarea a otra calle',
    'Creator Name' => 'Nombre del creador',
    'Time spent and estimated' => 'Tiempo transcurrido y estimado',
    'Move position' => 'Mover posición',
    'Move task to another position on the board' => 'Mover la tarea a otro lugar del tablero',
    ...
    'Add a new custom role' => 'Añadir un rol personalizado',
    'Restrictions for the role "%s"' => 'Restricciones del rol "%s"',
    'Add a new project restriction' => 'Añadir restricción al proyecto',
    'Add a new drag and drop restriction' => 'Añade una restricción de arrastrar y soltar',
    'Add a new column restriction' => 'Añadir restrición a la columna',
    'Edit this role' => 'Editar este rol',
    'Remove this role' => 'Eliminar este rol',
    'There is no restriction for this role.' => 'Este rol no tiene restricciones',
    'Only moving task between those columns is permitted' => 'Solo se permite mover tareas entre estas columnas',
    'Close a task in a specific column when not moved during a given period' => 'Cerrar la tarea en una columna especifica cuando no se ha movido en un periodo de tiempo',
    ...
    'Column restriction removed successfully.' => 'Restricción de columna eliminada correctamente',
    ...
    'Unable to create custom project role.' => 'No se puede crear el rol de proyecto personalizado',
    'Your custom project role has been updated successfully.' => 'El rol de proyecto personalizado se ha actualizado correctamente',
    'Unable to update custom project role.' => 'No se puede actualizar el rol de proyecto personalizado',
    'Custom project role removed successfully.' => 'El rol de proyecto personalizado se ha eliminado correctamente',
    'Unable to remove this project role.' => 'No se puede eliminar el rol de proyecto personalizado',
    'The project restriction has been created successfully.' => 'La restrición de proyecto se ha creado correctamente',
    'Unable to create this project restriction.' => 'No se puede crear esta restricción de proyecto',
    'Project restriction removed successfully.' => 'La restrición de proyecto se ha eliminado correctamente',
    'You cannot create tasks in this column.' => 'No puedes crear tareas en esta columna',
    'Task creation is permitted for this column' => 'Se pueden crear tareas en esta columna',
    'Closing or opening a task is permitted for this column' => 'Se pueden abrir y cerrar tareas en esta columna',
    'Task creation is blocked for this column' => 'Está bloqueada la creación de tareas en esta columna',
    'Closing or opening a task is blocked for this column' => 'Esta bloqueado abrir y cerrar tareas en esta columna',
    'Task creation is not permitted' => 'No se permite crear tareas',
    'Closing or opening a task is not permitted' => 'No se permite abrir o cerrar tareas',
    'New drag and drop restriction for the role "%s"' => 'Nueva retricción de arrastrar y soltar para el rol "%s"',
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => 'Las personas con este rol solo podrán mover tareas entre la columna origen y destino',
    'Remove a column restriction' => 'Eliminar restricción de la columna',
    'Do you really want to remove this column restriction: "%s" to "%s"?' => '¿Seguro que quieres eliminar la restricción de columna: "%s" a "%s"?',
    'New column restriction for the role "%s"' => 'Nueva restricción de columna para el rol "%s"',
    'Rule' => 'Regla',
    'Do you really want to remove this column restriction?' => '¿Seguro que quieres eliminar esta restricción de columna?',
    'Custom roles' => 'Roles personalizados',
    'New custom project role' => 'Nuevo rol personalizado de proyecto',
    'Edit custom project role' => 'Editar rol personalizado de proyecto',
    'Remove a custom role' => 'Eliminar rol personalizado',
    'Do you really want to remove this custom role: "%s"? All people assigned to this role will become project member.' => '¿Seguro que quieres eliminar este rol personalizado: "%s"? Todas las personas con ese rol, se convertirán en miembros del proyecto.',
    'There is no custom role for this project.' => 'No hay roles personalizados para este proyecto.',
    'New project restriction for the role "%s"' => 'Nueva restricción de royecto para el rol "%s"',
    'Restriction' => 'Restricción',
    'Remove a project restriction' => 'Eliminar restricción de proyecto',
    'Do you really want to remove this project restriction: "%s"?' => '¿Seguro que quieres eliminar esta restricción de proyecto: "%s"?',
    'Duplicate to multiple projects' => 'Duplicar a multiples proyectos',
    'This field is required' => 'Este campo es obligatorio',
    'Moving a task is not permitted' => 'No se permite mover la tarea',
    'This value must be in the range %d to %d' => 'Este valor tiene que estar en el rango entre %d hasta %d',
    'You are not allowed to move this task.' => 'No tienes permiso para mover esta tarea',
    'API User Access' => 'Usuario de acceso a la API',
    'Preview' => 'Previsualizar',
    'Write' => 'Escribir',
    'Write your text in Markdown' => 'Escribe tu texto en Markdown',
    'New External Task: %s' => 'Nueva tarea externa: %s',
    'No personal API access token registered.' => 'No se ha registrado ningún token de acceso a la API',
    'Your personal API access token is "%s"' => 'El token personal de acceso a la API es "%s"',
    'Remove your token' => 'Eliminar token',
    'Generate a new token' => 'Generar nuevo token',
);
